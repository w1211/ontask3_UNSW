...
class ContainerPermissions(permissions.BasePermission):
    def has_object_permission(self, request, view, obj):
        ...
        if request.method in ['PATCH', 'PUT']:
            ...
            return request_user == obj.owner or request_user in obj.sharing.readWrite
        elif request.method in ['DELETE']:
            # Only owners of the object can delete
            return request_user == obj.owner
        elif request.method in ['GET']:
            # Only owners or users given read or read & write access can view the object
            return request_user == obj.owner or request_user in obj.sharing.readOnly or request_user in obj.sharing.readWrite